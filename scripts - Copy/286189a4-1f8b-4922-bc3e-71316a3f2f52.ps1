...
git checkout -b 286189a4

git add .

git commit -m "Created 286189a4 branch
...
git push -u origin 286189a4

hub pull-request -m "Created 286189a4 branch" -h 286189a4 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 286189a4

# git push origin --delete 286189a4
