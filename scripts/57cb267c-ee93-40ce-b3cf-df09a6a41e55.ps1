...
git checkout -b 57cb267c

git add .

git commit -m "Created 57cb267c branch
...
git push -u origin 57cb267c

hub pull-request -m "Created 57cb267c branch" -h 57cb267c -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 57cb267c

# git push origin --delete 57cb267c
