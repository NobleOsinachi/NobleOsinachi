...
git checkout -b 04b7bac3

git add .

git commit -m "Created 04b7bac3 branch
...
git push -u origin 04b7bac3

hub pull-request -m "Created 04b7bac3 branch" -h 04b7bac3 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 04b7bac3

# git push origin --delete 04b7bac3
