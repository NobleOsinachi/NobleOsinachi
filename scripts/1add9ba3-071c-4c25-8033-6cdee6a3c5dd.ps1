...
git checkout -b 1add9ba3

git add .

git commit -m "Created 1add9ba3 branch
...
git push -u origin 1add9ba3

hub pull-request -m "Created 1add9ba3 branch" -h 1add9ba3 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 1add9ba3

# git push origin --delete 1add9ba3
