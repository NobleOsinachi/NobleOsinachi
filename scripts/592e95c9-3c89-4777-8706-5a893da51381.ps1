...
git checkout -b 592e95c9

git add .

git commit -m "Created 592e95c9 branch
...
git push -u origin 592e95c9

hub pull-request -m "Created 592e95c9 branch" -h 592e95c9 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 592e95c9

# git push origin --delete 592e95c9
