...
git checkout -b 9e364eb7

git add .

git commit -m "Created 9e364eb7 branch
...
git push -u origin 9e364eb7

hub pull-request -m "Created 9e364eb7 branch" -h 9e364eb7 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 9e364eb7

# git push origin --delete 9e364eb7
