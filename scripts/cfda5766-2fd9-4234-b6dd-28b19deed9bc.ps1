...
git checkout -b cfda5766

git add .

git commit -m "Created cfda5766 branch
...
git push -u origin cfda5766

hub pull-request -m "Created cfda5766 branch" -h cfda5766 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d cfda5766

# git push origin --delete cfda5766
