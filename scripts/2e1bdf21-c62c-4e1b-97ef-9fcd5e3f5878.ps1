...
git checkout -b 2e1bdf21

git add .

git commit -m "Created 2e1bdf21 branch
...
git push -u origin 2e1bdf21

hub pull-request -m "Created 2e1bdf21 branch" -h 2e1bdf21 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 2e1bdf21

# git push origin --delete 2e1bdf21
