...
git checkout -b 81871489

git add .

git commit -m "Created 81871489 branch
...
git push -u origin 81871489

hub pull-request -m "Created 81871489 branch" -h 81871489 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 81871489

# git push origin --delete 81871489
