...
git checkout -b 33fa5a14

git add .

git commit -m "Created 33fa5a14 branch
...
git push -u origin 33fa5a14

hub pull-request -m "Created 33fa5a14 branch" -h 33fa5a14 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 33fa5a14

# git push origin --delete 33fa5a14
