...
git checkout -b 15fdcd73

git add .

git commit -m "Created 15fdcd73 branch
...
git push -u origin 15fdcd73

hub pull-request -m "Created 15fdcd73 branch" -h 15fdcd73 -b main -f

# Only delete branch after all pulls have been merged by Golden
# git branch -d 15fdcd73

# git push origin --delete 15fdcd73
